...
export default function EditPinModal({ pin, onClose, onSaved }: EditPinModalProps) {
  ...
  const [tags, setTags] = useState<string[]>(getSelectedCategories(pin.tags))
  ...
  async function handleSave() {
    ...
    try {
      ...
      const updatedTags: Tag[] = tags.map(name => {
      ...
      >
        ...
        <div>
          <label style={labelStyle}>
            ...
            <span style={{ marginLeft: 'auto', fontSize: '0.75rem', color: 'var(--muted)', fontWeight: 400 }}>{title.length}/120</span>
          </label>
          <input
            type="text"
            value={title}
            ...
            style={{ ...editInputStyle, borderColor: fieldErrors.title ? '#ef4444' : 'var(--border)' }}
            ...
            onBlur={e => { e.currentTarget.style.borderColor = fieldErrors.title ? '#ef4444' : 'var(--border)'; e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.background = 'var(--surface)' }}
          />
          {fieldErrors.title && <p style={{ marginTop: 4, fontSize: '0.75rem', color: '#ef4444' }}>{fieldErrors.title}</p>}
        </div>
        ...
        <div>
          <label style={labelStyle}>
            Description
            <span style={{ marginLeft: 'auto', fontSize: '0.75rem', color: 'var(--muted)', fontWeight: 400 }}>{description.length}/2000</span>
          </label>
          <textarea
            value={description}
            ...
            style={{ ...editInputStyle, resize: 'none' as const, lineHeight: 1.6, borderColor: fieldErrors.description ? '#ef4444' : 'var(--border)' }}
            onFocus={e => { e.currentTarget.style.borderColor = 'var(--menthe)'; e.currentTarget.style.boxShadow = 'var(--shadow-glow)'; e.currentTarget.style.background = '#fff' }}
            onBlur={e => { e.currentTarget.style.borderColor = fieldErrors.description ? '#ef4444' : 'var(--border)'; e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.background = 'var(--surface)' }}
          />
          {fieldErrors.description && <p style={{ marginTop: 4, fontSize: '0.75rem', color: '#ef4444' }}>{fieldErrors.description}</p>}
        </div>
        ...
        <div>
          ...
          <input
            ...
            style={{ ...editInputStyle, borderColor: fieldErrors.liveUrl ? '#ef4444' : 'var(--border)' }}
            onFocus={e => { e.currentTarget.style.borderColor = 'var(--menthe)'; e.currentTarget.style.boxShadow = 'var(--shadow-glow)'; e.currentTarget.style.background = '#fff' }}
            onBlur={e => { e.currentTarget.style.borderColor = fieldErrors.liveUrl ? '#ef4444' : 'var(--border)'; e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.background = 'var(--surface)' }}
          />
          {fieldErrors.liveUrl && <p style={{ marginTop: 4, fontSize: '0.75rem', color: '#ef4444' }}>{fieldErrors.liveUrl}</p>}
        </div>
        ...
        <div>
          ...
          <input
            ...
            style={{ ...editInputStyle, borderColor: fieldErrors.repoUrl ? '#ef4444' : 'var(--border)' }}
            onFocus={e => { e.currentTarget.style.borderColor = 'var(--menthe)'; e.currentTarget.style.boxShadow = 'var(--shadow-glow)'; e.currentTarget.style.background = '#fff' }}
            onBlur={e => { e.currentTarget.style.borderColor = fieldErrors.repoUrl ? '#ef4444' : 'var(--border)'; e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.background = 'var(--surface)' }}
          />
          {fieldErrors.repoUrl && <p style={{ marginTop: 4, fontSize: '0.75rem', color: '#ef4444' }}>{fieldErrors.repoUrl}</p>}
        </div>
            ...
            {CATEGORY_OPTIONS.map(({ id, label }) => {
              ...
              return (
                <button
                  key={id}
                  type="button"
                  onClick={() => setTags(prev => prev.includes(id) ? prev.filter(t => t !== id) : [...prev, id])}
                  style={{
